    ...
    <div class="w3-bar w3-white w3-card" id="myNavbar">
        ...
        <c:choose>
            ...
            <form method="post" action="" style="display: inline;">
                <button name="command" class="w3-button w3-bar-item fa-lg" value="account" type="submit" style="padding: 19.5px;" ><i class="fa fa-user" aria-hidden="true"></i>
                </button>
        ...
        <div class="w3-right w3-hide-small">
            <button class="w3-bar-item w3-button" style="font-weight: bold" type="submit" name="command" value="index">HOME</button>
            ...
            <button class="w3-button w3-bar-item" type="submit" name="item" value="tablets"><i class="fa"></i>
                IPAD&TABLETS
            </button>
